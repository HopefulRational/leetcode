...
## Solution
```cpp
// https://leetcode.com/problems/insufficient-nodes-in-root-to-leaf-paths/solutions/308326/java-c-python-easy-and-concise-recursion
...
public:
    TreeNode* sufficientSubset(TreeNode* root, int limit) {
        ...
        // if both left & right existed but got removed, all paths from cur node are insufficient.
        // So remove cur node.
